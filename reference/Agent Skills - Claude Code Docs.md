...
categories: ["[[Clippings]]", "[[Web]]"]
icon: LiSquareBottomDashedScissors
publish: false
description: "Guide to creating, managing, and sharing Agent Skills in Claude Code—modular capabilities that extend Claude's functionality through organized folders with instructions and supporting files; covers personal/project/plugin Skills, best practices, debugging, and team distribution."
excerpt: "Create, manage, and share Skills to extend Claude's capabilities in Claude Code."
url: https://code.claude.com/docs/en/skills
author: ["[[Anthropic]]"]
published:
related: []
tags: [clippings, full-text, agent-skills, documentation, claude-code, guides]
created: 2025-12-05T00:00
modified: 2025-12-05T20:51
---
