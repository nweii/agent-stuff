...
- [recipe-vault](skills/recipe-vault/) _[Internal]_ — Search, read, filter, combine, adapt, and save recipes in the Brain vault collection at `03-Records/Clippings/Recipes`, via Obsidian CLI or nweii Brain MCP. Use whenever cooking and the collection are relevant — 'what should I make', 'recipes with miso', 'save this one' all imply it.
