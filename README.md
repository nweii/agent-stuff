...
- [herdr-cross-agent-coordination](skills/herdr-cross-agent-coordination/) — Use whenever an agent sends, receives, interprets, verifies, or responds to another agent through Herdr. Covers peer tasks, reports, questions, corrections, origin-pane checks, and stalled prompt delivery.
